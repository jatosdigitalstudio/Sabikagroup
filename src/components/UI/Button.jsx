export const Button = ({ children }) => {
    return (
      <button className="group py-4 px-8 bg-[#345DA3] rounded-xl font-semibold hover:bg-[#022D42] transition-colors duration-500 delay-[0.1s] ease-[cubic-bezier(0.19,1,0.22,1)]">
